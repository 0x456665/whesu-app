...
pub fn sample_children() -> Vec<ChildRecord> {
    vec![
        ChildRecord {
            ...
            emergency_contact_name: "David Johnson".to_string(),
            emergency_contact_phone: "+1(972)-555-0102".to_string(),
        },
        ChildRecord {
            id: 2,
            ...
            emergency_contact_name: "Sandra Carter".to_string(),
            emergency_contact_phone: "+1(469)-555-0113".to_string(),
        },
        ChildRecord {
            id: 3,
            ...
            allergies: "Dairy, Eggs".to_string(),
            emergency_contact_name: "Thanh Nguyen".to_string(),
            emergency_contact_phone: "+1(214)-555-0124".to_string(),
        },
        ChildRecord {
            id: 4,
            ...
            allergies: "Shellfish".to_string(),
            emergency_contact_name: "Marcus Brooks".to_string(),
            emergency_contact_phone: "+1(972)-555-0135".to_string(),
        },
        ChildRecord {
            id: 5,
            ...
            allergies: "None".to_string(),
            emergency_contact_name: "Alex Reed".to_string(),
            emergency_contact_phone: "+1(214)-555-0146".to_string(),
        },
    ]
}
